...
export default function FireDashboard() {
  ...
  async function fetchData() {
    ...
    try {
      ...
      setResponders(all.filter((r: Responder) => r.type === "fire_truck"));
    } catch (err) {
      console.error(err);
    } finally {
      setLoading(false);
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        >
          <div style={{ marginBottom: isMobile ? "12px" : "0" }}>
            ...
            <p style={{ fontSize: "12px", color: "var(--muted)" }}>
              Manage fire service units and availability
            </p>
          </div>
        ...
        >
          ...
          >
            ...
            >
              FIRE SERVICE UNITS ({responders.length})
            </span>
          </div>
          ...
          {responders.length === 0 ? (
            ...
            >
              No fire service units registered yet. Click &quot;Register
              Unit&quot; to add one.
            </div>
          ) : (
